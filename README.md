...
The script [`build-with-cli.sh`](build-with-cli.sh) can be used to build the `catena4617_simple` sketch using the [`arduino-cli`](https://github.com/arduino/arduino-cli).
